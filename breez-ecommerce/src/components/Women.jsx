...
export default function Women() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen gap-30 md:flex-row flex-col">
      {/* Left side */}
      ...
      <div className="flex flex-col items-start gap-4">
        ...
        <div className="flex gap-4 font-bold text-left ">
          ...
          <span className="flex items-center justify-center bg-black px-2 py-1 text-white rounded text-xs">
            50%
          </span>
        </div>
        <span className="font-bold text-left line-through">
          <h1>$250.00</h1>
        </span>
